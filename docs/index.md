...
| You want Gemma 4 31B (thinking on vs off) and Poolside's Laguna S 2.1 on the Spark: why fatter tokenizers push Goldman into chunks, and the fastest local run after gpt-oss-120b | [eval-report-2026-09-spark-cuda-gemma-laguna.md](eval-report-2026-09-spark-cuda-gemma-laguna.md) | Gemma / Laguna add-on (Sept 19–20, 2026) |
